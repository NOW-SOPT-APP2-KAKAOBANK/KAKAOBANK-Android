...
class HistoryAdapter : ListAdapter<ResponseMonthPayment.MonthlyTransfer, RecyclerView.ViewHolder>(HistoryAdapterDiffCallback) {
    ...
    companion object {
        ...
        private val HistoryAdapterDiffCallback = ItemDiffCallback<ResponseMonthPayment.MonthlyTransfer>(
